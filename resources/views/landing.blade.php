    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="#menu">Pembayaran</a></li>
          <li><a href="#events">Venue</a></li>
          <li class="dropdown"><a href="#"><span>Vendor</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
    ...
    <div class="container">
      ...
      <div class="row justify-content-between gy-5">
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          {{-- <img src="assets/img/landing.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="300"> --}}
        </div>
      </div>
    </div>
